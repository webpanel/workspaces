...
var WorkspaceSettings = /** @class */ (function (_super) {
    ...
    WorkspaceSettings.prototype.render = function () {
        var _a = this.props, workspaceID = _a.workspaceID, dataSource = _a.dataSource, roles = _a.roles;
        ...
        return (React.createElement(Row, { gutter: 8 },
            ...
            React.createElement(Col, { span: 12 },
                React.createElement(Card, { title: "Members" },
                    React.createElement(MembershipList, { roles: roles, entity: "Workspace", entityID: workspaceID })))));
    };
