...
var WorkspacesLayer = /** @class */ (function (_super) {
    ...
    function WorkspacesLayer(props) {
        return _super.call(this, props) || this;
    }
    WorkspacesLayer.prototype.getCurrentWorkspace = function () {
        return;
    };
    WorkspacesLayer.prototype.render = function () {
        ...
        return (React.createElement(Query, { query: MEBMERSHIPS_QUERY, variables: variables, children: function (_a) {
                ...
                return (React.createElement(ResourceCollectionLayer, { dataSource: api, name: "Workspace", fields: ['id', 'name'], initialFilters: { id_in: workspacesIDs }, render: function (_a) {
