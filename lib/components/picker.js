...
var WorkspacePicker = /** @class */ (function (_super) {
    ...
    WorkspacePicker.prototype.render = function () {
        var _this = this;
        var _a = this.props, dataSource = _a.dataSource, memberID = _a.memberID;
    ...
    WorkspacePicker.prototype.errorModal = function (message) {
        ...
        return (React.createElement(Modal, { visible: true, closable: false, footer: React.createElement(Button, { type: "primary", onClick: function () { return onLogout(); } }, "Logout") },
